// <copyright file="ExerciseLibraryEquipmentEquipmentGroupsController.cs" company="APIMatic">
...
namespace JustGainsAPI.Standard.Controllers
{
    ...
    /// </summary>
    public class ExerciseLibraryEquipmentEquipmentGroupsController : BaseController
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExerciseLibraryEquipmentEquipmentGroupsController"/> class.
        /// </summary>
        internal ExerciseLibraryEquipmentEquipmentGroupsController(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
