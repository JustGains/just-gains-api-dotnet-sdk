// <copyright file="ExerciseLibraryExerciseCategoriesController.cs" company="APIMatic">
...
namespace JustGainsAPI.Standard.Controllers
{
    ...
    /// </summary>
    public class ExerciseLibraryExerciseCategoriesController : BaseController
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExerciseLibraryExerciseCategoriesController"/> class.
        /// </summary>
        internal ExerciseLibraryExerciseCategoriesController(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
