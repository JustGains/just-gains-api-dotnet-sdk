// <copyright file="ExerciseLibraryExercisesController.cs" company="APIMatic">
...
namespace JustGainsAPI.Standard.Controllers
{
    ...
    /// </summary>
    public class ExerciseLibraryExercisesController : BaseController
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExerciseLibraryExercisesController"/> class.
        /// </summary>
        internal ExerciseLibraryExercisesController(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
        ...
        /// <param name="localeCode">Optional parameter: The locale codes to filter by (e.g., 'en-US', 'es-ES').</param>
        ...
        public Models.ExerciseTranslationListResponse GetExerciseTranslations(
            ...
            => CoreHelper.RunTask(GetExerciseTranslationsAsync(exerciseCode, localeCode));
