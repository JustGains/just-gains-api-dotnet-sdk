// <copyright file="ExerciseLibraryMusclesMuscleGroupsController.cs" company="APIMatic">
...
namespace JustGainsAPI.Standard.Controllers
{
    ...
    /// </summary>
    public class ExerciseLibraryMusclesMuscleGroupsController : BaseController
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExerciseLibraryMusclesMuscleGroupsController"/> class.
        /// </summary>
        internal ExerciseLibraryMusclesMuscleGroupsController(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
        ...
        public Models.JustGainsBasicResponse UpdateMuscleGroupTranslations(
            ...
            => CoreHelper.RunTask(UpdateMuscleGroupTranslationsAsync(muscleGroupCode, body, localeCodes));
