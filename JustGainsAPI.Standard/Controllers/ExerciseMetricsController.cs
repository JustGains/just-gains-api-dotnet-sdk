    ...
    public class ExerciseMetricsController : BaseController
    {
        ...
        public async Task<Models.JustGainsBasicResponse> CreateANewExerciseMetricAsync(
            ...
            => await CreateApiCall<Models.JustGainsBasicResponse>()
              ...
              .ResponseHandler(_responseHandler => _responseHandler
                  .ErrorCase("400", CreateErrorCase("Bad request", (_reason, _context) => new ExerciseMetrics400Error2Exception(_reason, _context))))
              .ExecuteAsync(cancellationToken).ConfigureAwait(false);
            ...
            => await CreateApiCall<Models.JustGainsResponse>()
              .RequestBuilder(_requestBuilder => _requestBuilder
                  ...
                  .Parameters(_parameters => _parameters
                      .Template(_template => _template.Setup("metricCode", metricCode))))
              .ResponseHandler(_responseHandler => _responseHandler
                  .ErrorCase("404", CreateErrorCase("Exercise metric deleted successfully", (_reason, _context) => new JustGainsErrorResponseException(_reason, _context))))
              .ExecuteAsync(cancellationToken).ConfigureAwait(false);
    }
}