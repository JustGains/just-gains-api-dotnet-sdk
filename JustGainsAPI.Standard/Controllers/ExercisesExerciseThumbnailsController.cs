...
namespace JustGainsAPI.Standard.Controllers
{
    ...
    public class ExercisesExerciseThumbnailsController : BaseController
    {
        ...
        /// <summary>
        /// getExerciseThumbnailByCreatorProfileId EndPoint.
        /// </summary>
        ...
        public Models.ExerciseThumbnailResponse GetExerciseThumbnailByCreatorProfileId(
                string exerciseCode,
                string creatorProfileId)
            => CoreHelper.RunTask(GetExerciseThumbnailByCreatorProfileIdAsync(exerciseCode, creatorProfileId));
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.ExerciseThumbnailResponse response from the API call.</returns>
        public async Task<Models.ExerciseThumbnailResponse> GetExerciseThumbnailByCreatorProfileIdAsync(
                string exerciseCode,
                string creatorProfileId,
                CancellationToken cancellationToken = default)
        ...
        public async Task<Models.ExerciseThumbnailResponse> AddOrUpdateExerciseThumbnailAsync(
            ...
            => await CreateApiCall<Models.ExerciseThumbnailResponse>()
              .RequestBuilder(_requestBuilder => _requestBuilder
                  .Setup(HttpMethod.Post, "/exercises/{exerciseCode}/thumbnails/{creatorProfileId}")
                  .WithAuth("bearerAuth")
                  .Parameters(_parameters => _parameters
