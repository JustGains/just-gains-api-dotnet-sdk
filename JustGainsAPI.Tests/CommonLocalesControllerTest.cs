// <copyright file="CommonLocalesControllerTest.cs" company="APIMatic">
...
{
    /// <summary>
    /// CommonLocalesControllerTest.
    /// </summary>
    [TestFixture]
    public class CommonLocalesControllerTest : ControllerTestBase
    {
        /// <summary>
        /// Controller instance (for all tests).
        /// </summary>
        private CommonLocalesController controller;
        ...
        {
            this.controller = this.Client.CommonLocalesController;
        }
