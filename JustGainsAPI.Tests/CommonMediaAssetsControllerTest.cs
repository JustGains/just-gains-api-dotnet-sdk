// <copyright file="CommonMediaAssetsControllerTest.cs" company="APIMatic">
...
{
    /// <summary>
    /// CommonMediaAssetsControllerTest.
    /// </summary>
    [TestFixture]
    public class CommonMediaAssetsControllerTest : ControllerTestBase
    {
        /// <summary>
        /// Controller instance (for all tests).
        /// </summary>
        private CommonMediaAssetsController controller;
        ...
        {
            this.controller = this.Client.CommonMediaAssetsController;
        }
