// <copyright file="EquipmentControllerTest.cs" company="APIMatic">
...
namespace WorkoutCreatorAPI.Tests
{
    ...
    /// </summary>
    [TestFixture]
    public class EquipmentControllerTest : ControllerTestBase
    {
        /// <summary>
        ...
        {
            this.controller = this.Client.EquipmentController;
        }
        ...
        public async Task TestTestGetEquipments()
        {
            ...
            // Perform API call
            Standard.Models.EquipmentResponse result = null;
            try
            {
