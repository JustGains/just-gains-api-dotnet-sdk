// <copyright file="ExerciseCategoriesControllerTest.cs" company="APIMatic">
...
{
    /// <summary>
    /// ExerciseCategoriesControllerTest.
    /// </summary>
    [TestFixture]
    public class ExerciseCategoriesControllerTest : ControllerTestBase
    {
        /// <summary>
        /// Controller instance (for all tests).
        /// </summary>
        private ExerciseCategoriesController controller;
        ...
        {
            this.controller = this.Client.ExerciseCategoriesController;
        }
        ...
        public async Task TestTestGetExerciseCategories()
        {
            ...
            // Perform API call
            Standard.Models.ExerciseCategoriesResponse result = null;
            try
            {
