...
|  --- | --- | --- | --- |
| `ProgramId` | `int?` | Optional | Unique identifier for the program. |
| `UserId` | `Guid?` | Optional | Identifier of the user who created the program. |
| `ProgramName` | `string` | Optional | Name of the training program. |
| `ProgramDescription` | `string` | Optional | Detailed description of the program, its goals, and target audience. |
| `ProgramThumbnail` | [`ProgramThumbnail`](../../doc/models/program-thumbnail.md) | Optional | Thumbnail image representing the program. |
| `PublishStatusCode` | `string` | Optional | Code indicating the publish status of the program (e.g., draft, published, archived). |
| `CreatedAt` | `DateTime?` | Optional | Timestamp of when the program was created. |
| `UpdatedAt` | `DateTime?` | Optional | Timestamp of when the program was last updated. |
